    ...
    public Integer call() throws Exception {
        try {
            ...
            if (jsonOutput) {
                ...
                System.out.println("resourceType:"+excelFile.getAbsolutePath());
                System.out.println("resourceType:"+this.resourcePath);
                System.out.println("resourceType:"+this.outImgPath);
...
//			String dstImgPath=Paths.get("D:\\cache\\html1\\resourceImg",outImgs[i]).toString();
			URI srcImgPath=Paths.get(outImgPath, String.valueOf(resourceId),jpgName).toUri();
			URI dstImgPath=Paths.get(outImgPath, String.valueOf(resourceId)+String.valueOf(size),jpgName).toUri();
